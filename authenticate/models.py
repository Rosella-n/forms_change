...
# @receiver(post_delete, sender='authenticate.Temp_Scanned_Documents')
# def auto_delete_temp_file_on_delete(sender, instance, **kwargs):
#     """
#         Deletes file from filesystem
#         when corresponding `MediaFile` object is deleted.
#         """
#     if instance.temp_pdf_file:
#         if os.path.isfile(instance.temp_pdf_file.path):
#             (instance.temp_pdf_file.close())
#             os.remove(instance.temp_pdf_file.path)
...
def user_profile_pics_path(instance, filename):
    ...
    return 'profile_pictures/user_{0}/{1}'.format(instance.id_numb, filename)
